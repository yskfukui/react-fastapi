...
export const Header = ({ title }) => {
  ...
  return (
    <nav
      className="navbar has-background-light has-text-white"
      role="navigation"
    ...
    >
      ...
      <div className="navbar-start is-size-5">
        <li className="navbar-item">
          <Link className="has-text-gray has-text-weight-semibold" to="/">
            ホーム
          </Link>
        </li>
        <li className="navbar-item">
          <Link className="has-text-gray has-text-weight-semibold" to="/page1">
            ページ1
          </Link>
        </li>
        <li className="navbar-item">
          <Link className="has-text-gray has-text-weight-semibold" to="/page2">
            ページ2
          </Link>
        </li>
      </div>
        ...
        <div className="navbar-item">
          <div className="columns">
            ...
            <div className="column">
              {token && (
                <button
                  className="button is-light is-gray"
